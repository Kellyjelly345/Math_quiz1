...
function send(){
    ...
    question_word = "<h4 id='show_word'>Q. "+remove_letter3+"</h4> <br>";
    input_box = "Answer <input type='text' id='answer_input'> <br> <br>";
    check_button = "<button class='btn btn-info' onclick='check()'>Check</button>";
    joined_row = question_word + input_box + check_button;
    document.getElementById("output").innerHTML = joined_row;
